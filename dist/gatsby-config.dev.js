...
module.exports = {
  ...
  plugins: ["gatsby-plugin-react-helmet", {
    ...
    options: {
      name: "markdown-pages",
      path: "".concat(__dirname, "/src/content")
    }
  }, {
    resolve: "gatsby-source-filesystem",
    options: {
  ...
  }, "gatsby-transformer-sharp", "gatsby-plugin-sharp", "gatsby-plugin-emotion", {
    ...
    options: {
      ...
      transformHeaders: function transformHeaders(headers, path) {
        return headers;
      },
